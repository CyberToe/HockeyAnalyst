                              ...
                              <td className="px-4 py-2 text-sm">
                                <div className="flex space-x-2">
                                  <button
                                    ...
                                    className="px-4 py-2 bg-green-100 text-green-700 rounded hover:bg-green-200 text-lg font-bold disabled:opacity-50 min-w-[40px]"
                                  >
                                    +
                                  </button>
                                  <button
                                    ...
                                    disabled={incrementFaceoffMutation.isPending}
                                    className="px-4 py-2 bg-red-100 text-red-700 rounded hover:bg-red-200 text-lg font-bold disabled:opacity-50 min-w-[40px]"
                                  >
                                    -
                                  </button>
                                </div>
